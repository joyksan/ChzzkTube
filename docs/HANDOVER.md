...
> 마지막 갱신: 2026-09-17 - v3.6.2 — OS 격리 HAL + 구독형 워치독 완전 전환 (패치 업)
...
- **버전**: `v3.6.2` — 정의 위치 `config._APP_VERSION`; 메타 참고값은 `pyproject.toml` `version = "3.6.2"` (최신: 2026-09-17 OS 격리 HAL + 구독형 워치독 완전 전환)
