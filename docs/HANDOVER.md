...
> 마지막 갱신: 2026-09-26 - v3.12.2 — Windows 의존성 정합성 루프 정비·다운로드 진행률 규격 개편·F12 터미널 원문 로깅 체계 구축
---
## 목차
...
- **버전**: `v3.12.2` — 정의 위치 `config._APP_VERSION`; 메타 참고값은 `pyproject.toml` `version = "3.12.2"` (최신: 2026-09-26 Windows 의존성 정합성 루프 정비·다운로드 진행률 규격 개편·F12 터미널 원문 로깅 체계 구축)
